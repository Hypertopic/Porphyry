...
public class CloseViewpoint extends SwingWorker <Set<Portfolio.Topic>,Void> {//>

private String viewpoint;
private Portfolio portfolio;

public CloseViewpoint(Portfolio portfolio, String viewpoint) {
	this.viewpoint = viewpoint;
	this.portfolio = portfolio;
}

@Override protected Set<Portfolio.Topic> doInBackground() throws Exception {
	this.portfolio.closeViewpoint(this.viewpoint);
