...
Scénario:
	Soit un item en cours de création
	Et l'utilisateur "damien" connecté
	Quand  l'utilisateur indique "https://ju.se/en/study-at-ju/become-an-exchange-student.html" comme valeur de
	l'attribut "link"
	Alors la valeur de l'attribut "link" est "https://ju.se/en/study-at-ju/become-an-exchange-student.html"
