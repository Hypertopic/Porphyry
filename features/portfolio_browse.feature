...
Scénario: en retirant une rubrique
  ...
  Et "SJ 000" un des items cachés
  Et "Personnages" une des rubriques développées
  Et "AT" une des rubriques développées
  Quand on désélectionne la rubrique "Abram/Abraham"
...
Scénario: en excluant plusieurs rubriques au choix

  Soit "Datation|Artiste" les rubriques sélectionnées négativement
  Et "PSM 002" un des items affichés
  Et "SJ 001" un des items affichés
  Et "SNZ 005" un des items affichés
