...
Scénario: en remplaçant le ET par OU sur des selections négatives
  Soit "Datation|Technique narrative" les rubriques sélectionnées négativement
  Et "PSM 002" un des items affichés
  Et "SJ 001" un des items affichés
  Et "SNZ 005" un des items affichés
  Et "SNZ 009" un des items affichés
  Quand l'utilisateur change l'opérateur entre la rubrique "Datation" et la rubrique "Technique narrative"
  Alors l'item "PSM 002" est affiché
  Et l'item "SJ 001" est affiché
  Et l'item "SNZ 005" est affiché
