...
Et l'utilisateur est connecté
Et l'utilisateur est sur la page d'édition de l'item "SR 005"
Quand l'utilisateur renseigne l'attribut "spatial" préexistant avec la valeur "Église Sainte-Madeleine, Troyes" proposée parmi les valeurs existantes en recherchant "spat" et "église"
