...
class Item extends Component {
  ...
  _getAttributeCreationForm() {
    ...
    var placeholder="AddAttributValueButton";
    if (this.state.attributeInputFocus) {
      ...
      <form onSubmit={this._submitAttribute} className={classes.join(" ")}>
        <div className="attributeInput">
          <input ref={(input) => this.attributeInput=input} value={this.state.attributeInputValue}
            ...
            id="new-attribute" className="form-control" placeholder={placeholder.t()} type="text" />
        </div>
  ...
  _removeTopic(topicToDelete) {
    ...
    if (window.confirm(confirmMessage.t())) {
      return this._getOrCreateItem()
        .then(data => {
          data.topics=data.topics || {};
...
class Viewpoint extends Component {
  ...
  render() {
    ...
    let ChooseParentSection = "ChooseParentSection";
    const inputProps = {
      placeholder: this.state.newTopic ? ChooseParentSection.t() : Ajouter_une_rubrique.t(),
